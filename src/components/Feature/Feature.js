      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 bg-dark">
        <div className="card bg-base-100 shadow-2xl transform transition duration-500 hover:scale-125 hover:bg-cyan-700">
          <div className="card-body">
            ...
            <p>
              To create and maintain a website is my work. I'm also responsible
        ...
        <div className="card bg-base-100 shadow-2xl transform transition duration-500 hover:scale-125 hover:bg-cyan-700">
          <div className="card-body">
            ...
            <p>
              I will make your website good user experience.By best UI UX design
              I create the user interface for an app, website, or other
              interactive media
            </p>
            <div className="card-actions justify-end">
              <FaArrowRight className="text-pink-600"></FaArrowRight>
        ...
        <div className="card bg-base-100 shadow-2xl transform transition duration-500 hover:scale-125 hover:bg-cyan-700">
          <div className="card-body">
            ...
            <p>
              I’ll handle everything from to app development process until it is
